...
const phrases = [
  {
    ...
    answers: [
      "nice to hear from you, such a great day, how is it going",
      "hello there, feeling so good, how are you today",
      "hey boddy, best day ever, how are you",
    ],
  },
  {
    tag: "bye",
    ...
    answers: [
      ...
      "so glad to hear you, see you later",
      "have a nice day, come back later",
    ],
  },
  {
    tag: "story.food",
    ...
    answers: [
      "once i cooked a {{food}}, but it was too salty, no one liked it",
      "i bought a {{food}} several days ago, i think it is very expencive, but at the same time it worth it",
      "my friend tried to treat me with a {{food}}, but he didn't success because i don't eat anything",
    ],
  },
  {
    tag: "story.animal",
    triggers: [
      "i like %animal%",
      "a %animal%",
      "a %animal% is %characteristic%",
      "story about a %animal%",
    ],
    answers: [
      "my friend's {{animal}} is so funny, i think it even smarter than me",
      "i saw a {{animal}} outdoors last week, but it was very scared and i didn't find way to catch it",
      "yesterday i noticed a {{animal}} eating my oranges, i don't know why but it liked it",
    ],
  },
  {
    tag: "story.person",
    triggers: [
      ...
      "a %person%",
      "a %person% is %characteristic%",
      "tell something about a %person%",
      "do you know a %person%",
    ],
    answers: [
      "i called a {{person}} yesterday because i needed his help",
      "once i witnessed people asking a {{person}} to climb a tree, it was really strange",
      "my old friend is a {{person}}, he says sometimes it is hard to do the work but he loves his job",
    ],
  },
  {
    tag: "story.item",
    triggers: [
      "do you use a %item%",
      "tell me about a %item%",
      "a %item%",
      "do you know a %item%",
    ],
    answers: [
      "i remember times when i used to use a {{item}} to clean my head, sounds strange but it is truth",
      "sometimes i take a {{item}} an put it in a fridge, everyone wonders why and so i am",
      "i had a task to entertain a group of people and unfortunately a {{item}} was the only available tool for me",
    ],
  },
  {
    tag: "opinion",
  ...
  },
  {
    ...
    answers: [
      "well, you should definitely try to make up a plan, i always do it when i have any problems",
      "i'm not sure, but my friend always advises me not to give up",
      "once a person said me to take any item and imagine all the ways i can use it, it helped me to improve creativity",
      "i don't know, ask your cat, maybe it will help",
    ],
  },
  {
    tag: "detail",
    ...
    answers: [
      ...
      "maybe i can try to give you more information, what are you interested in",
    ],
  },
  {
    tag: "info",
    ...
    answers: ["you can call me whatever you like"],
  },
  {
    tag: "thanks",
    triggers: [
    ...
    answers: ["no problem", "happy to help", "any time", "my pleasure"],
  },
  {
    tag: "understand",
    triggers: [
  ...
  },
  {
    ...
    answers: [
      ...
      "Dark said I tried to understand because I did not get it right this time ether",
      ...
      "Mel said he to because all of the music people say how important it is to take private lessons it seems like almost everybody from",
    ],
  },
  {
      tag: "joke",
...
module.exports = { entities, phrases };
